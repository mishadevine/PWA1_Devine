...
console.log('------ strings ----------');
    ...
    testString = "I need some \"quotes\"to be here.";
 ...
 */
    ...
    if("a"<"b"){
        ...
        console.log("all others returned false");
    }
 ...
 */
    ...
    if((1===1) && ("hi"==="hi")){
        console.log("both sides = True");
    }

    //OR logical operator
    if((1===1) || ("hi"==="no")){
        console.log("one side = True");
    }

    // ! NOT logical operator
    if(!(1===1) || ("hi"==="no")){
        console.log("left is true, converted to not");
    }else {
        console.log("both side = False");
    }
